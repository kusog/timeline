...
Timeline.createBandInfo = function(params) {
    ...
    if ("eventPainter" in params) {
        ...
        switch (layout) {
            ...
            //    break;
            //case "compact":
            //    eventPainter = new Timeline.CompactEventPainter(eventPainterParams);
            //    break;
            default:
...
$.extend(Timeline._Impl.prototype, {
    ...
    getContainer: function () { return this._containerDiv; },
