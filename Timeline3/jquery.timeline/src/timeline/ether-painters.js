...
$.extend(Timeline.GregorianEtherPainter.prototype, {
    initialize: function (band, timeline) {
        ...
        this._backgroundLayer = band.createLayerDiv(0).addClass('timeline-ether-bg').show().get(0);
    ...
    setHighlight: function (startDate, endDate, orthogonalOffset, orthogonalExtent) {
    ...
    paint: function () {
        ...
        this._markerLayer = this._band.createLayerDiv(100).get(0);

        if (this._lineLayer) {
            this._band.removeLayerDiv(this._lineLayer);
        }
        this._lineLayer = this._band.createLayerDiv(1).get(0);
    ...
    zoom: function (netIntervalChange) {
...
$.extend(Timeline.HotZoneGregorianEtherPainter.prototype, {
    ...
    setHighlight: function (startDate, endDate) {
...
$.extend(Timeline, {
    EtherIntervalMarkerLayout: function (timeline, band, theme, align, showLine) {
    ...
    EtherHighlight: function (timeline, band, theme, backgroundLayer) {
        var horizontal = timeline.isHorizontal();
