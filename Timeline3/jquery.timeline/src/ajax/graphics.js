$.extend(SimileAjax.Graphics, {
    ...
    //mjd: if you really want to support ie6, load the css file via your own process.
    //if (!SimileAjax.Graphics.pngIsTranslucent) {
    //    SimileAjax.includeCssFile(document, Timeline.urlPrefix + "styles/graphics-ie6.css");
    //}
    ...
    //_createTranslucentImage2: function (url, verticalAlign) {
    //    var elmt = document.createElement("img");
     ...
     */
    //createTranslucentImage: (SimileAjax.Graphics.pngIsTranslucent ?
    ...
    //_createTranslucentImageHTML2: function (url, verticalAlign) {
    //    var style =
    ...
    // */
    //createTranslucentImageHTML: (SimileAjax.Graphics.pngIsTranslucent ?
     ...
     */
    createStructuredDataCopyButton: function (image, width, height, createDataFunction) {
     ...
     *==================================================
     */
    getFontRenderingContext: function (elmt, width) {
        return new SimileAjax.Graphics._FontRenderingContext(elmt, width);
    },

    _FontRenderingContext: function (elmt, width) {
        this._elmt = elmt;
     ...
     */
    createAnimation: function (f, from, to, duration, cont) {
        return new SimileAjax.Graphics._Animation(f, from, to, duration, cont);
    },

    _Animation: function (f, from, to, duration, cont) {
        this.f = f;
...
$.extend(SimileAjax.Graphics._FontRenderingContext.prototype, {
    ...
    computeSize: function (text, className) {
